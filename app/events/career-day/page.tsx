        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
          <div className="order-2 lg:order-1">
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="aspect-square relative rounded-2xl overflow-hidden">
                <Image src="/_MG_3888.webp" alt="Engineering demonstration" fill className="object-cover" sizes="(min-width: 768px) 25vw, 50vw" />
              </div>
              <div className="aspect-square relative rounded-2xl overflow-hidden">
                <Image src="/_MG_3898.webp" alt="Laywer" fill className="object-cover" sizes="(min-width: 768px) 25vw, 50vw" />
              </div>
              <div className="aspect-square relative rounded-2xl overflow-hidden">
