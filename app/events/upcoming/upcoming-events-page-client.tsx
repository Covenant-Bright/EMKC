...
export default function UpcomingEventsPage() {
  ...
  const upcomingEvents = [
    {
      ...
      time: "Shared with parents before the programme",
    ...
    },
    {
      ...
      date: "Date to be announced",
      time: "Shared during the festive term",
      location: "All Branches",
    ...
    },
    {
      ...
      date: "Annual event",
      time: "Shared with participating families",
      location: "All Branches",
      category: "Sport",
      description:
  ...
  useEffect(() => {
    ...
    if (selectedCategory !== "All Events") {
      results = results.filter((event) => event.category.toLowerCase() === selectedCategory.toLowerCase())
    }
